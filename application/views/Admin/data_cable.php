        ...
        <div class="content">
            <div class="table-responsive">
                <h3>Data Kabel Metro Witel Banten Timur</h3>
                          ...
                          <?php
                             ...
                             foreach ($kabel as $b) {
                               ...
                               echo "<tr>
                                       ...
                                       <td>
                                          <center><a class = 'btn' href='".base_url()."index.php/admin/FormEditCable/".$b->kode_kabel."'>Sunting</a></center>
                                       </td>
                                       <td>
                                          <center><a class = 'btn' href='".base_url()."index.php/admin/AksiDeleteCable/".$b->kode_kabel."' onclick='javascript : return confirm('Yakin hapus?')'>Hapus</a></center>
                                       </td>
                                    </tr>";
                               $no++;
                             }
                 ...
                 <center>
                  <br>
                    <a button type="button" class="btn btn-default" href="<?php echo base_url() ?>index.php/admin/FormAddCable" role="button">Tambah Data</a>
