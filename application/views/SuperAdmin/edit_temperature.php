...
<div class="wrapper">
    ...
    <div class="main-panel">
        ...
        <div class="content">
            ...
            <center>
                    <h2>FORM EDIT DATA SUHU METRO</h2><br>
                    <?php
                        echo form_open_multipart ("superadmin/AksiEditTemperature", array("class"=>"form-horizontal"));
                           foreach ($metro as $r) {       
                            ...
                            echo form_input(array("name"  => "tanggal_input",
                                                  ...
                                                  "placeholder" => "Tanggal Input dd-mm-yyyy",
                                                  "type"  => "date"));
                            echo "<br>";
                            echo form_input (array("name" => "evidence",
                                                   "type" => "file"));
                            echo "<br>";
                            echo form_input(array("name"  => "id_metro",                             
                                                  "value" => $r->id_metro,                             
                                                  "type"  => "hidden"));
                    ...
                    ?>
                    <span style="width:10%; text-align:right;  display: inline-block;"><a class="small-text" href="<?php echo base_url('index.php/superadmin/temperature')?>">Batal</a></span>
            </center>
            </div>
        </div>
