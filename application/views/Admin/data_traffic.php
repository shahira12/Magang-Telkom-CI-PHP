    ...
    <div class="main-panel">
        ...
        <div class="content">
            <div class="container-fluid">
                            ...
                            <?php
                                 ...
                                 foreach ($datatraffic as $dt) {
                                   echo "<tr>
                                            ...
                                            <td>
                                            <center><a class='btn' href='".base_url()."index.php/admin/FormEditDataTraffic/".$dt->id_traffic."'>Sunting</a></center>
                                            </td>
                                            <td>
                                            <center><a class='btn' href='".base_url()."index.php/admin/AksiDeleteDataTraffic/".$dt->id_traffic."'>Hapus</a></center>
                                           </td>
                                        </tr>";
                                   $no++;
                                }
                        ...
                        <br/>
                        <center>
                            <a button type="button" class="btn btn-default" href="<?php echo base_url() ?>index.php/admin/FormAddTraffic" role="button">Tambah Data</a>
