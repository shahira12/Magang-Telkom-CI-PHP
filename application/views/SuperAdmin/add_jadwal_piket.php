...
<div class="wrapper">
    ...
    <div class="main-panel">
        ...
        <div class="content">
           ...
           <center>
            <h2>FORM TAMBAH JADWAL PIKET</h2>
                    <?php
                        echo form_open ("superadmin/AksiAddPiket", array("class"=>"form-horizontal"));
                    ...
                    <?php
                          echo form_input (array("class" => "btn btn-success",
                                                 ...
                                                 "value" => "Simpan"));
                    ?>
                    <span style="width:10%; text-align:right;  display: inline-block;"><a class="small-text" href="<?php echo base_url('index.php/superadmin/jadwal_piket')?>">Batal</a></span>
            </center>
            </div>
        </div>
