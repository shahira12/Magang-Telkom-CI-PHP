            ...
            <div class="container-fluid">
              <h3>Data Kabel Metro Witel Banten Timur</h3>
                <table align="center" cellspacing="0" cellpadding="5" width="100%">
                  ...
                  <?php
                     ...
                     foreach ($temperatur as $t) {
                       ...
                       echo "<tr>
                               ...
                               <td>
                                 <center><a class = 'btn' href='".base_url()."index.php/admin/FormEditTemperature/".$t->id_metro."'>Sunting</a></center>
                               </td>
                               <td>
                                 <center><a class = 'btn' href='".base_url()."index.php/admin/AksiDeleteTemperature/".$t->id_metro."'>Hapus</a></center>
                               </td>
                            </tr>";
                       $no++;
                     }
                 ...
                 <center>
                  <br>
                    <a button type="button" class="btn btn-default" href="<?php echo base_url() ?>index.php/admin/FormAddTemperature" role="button">Tambah Data</a>
