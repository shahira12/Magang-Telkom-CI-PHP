        ...
        <div class="content">
            <div class="container-fluid">
                        ...
                        <h3>Data Trunk Metro Witel Banten Timur</h3>
                                ...
                                $no=1;
                                 foreach ($data_trunk as $d) {
                                   echo "<tr>
                                            ...
                                            <td>
                                            <center><a class='btn' href='".base_url()."index.php/admin/FormEditTrunk/".$d->id."'>Sunting</a></center>
                                            </td>
                                            <td>
                                            <center><a class='btn' href='".base_url()."index.php/admin/AksiDeleteTrunk/".$d->id."'>Hapus</a></center>
                                           </td>
                                        </tr>";
                                    $no++;
                                }
                            ...
                            <br/>
                                <center>
                                    <a button type="button" class="btn btn-default" href="<?php echo base_url() ?>index.php/admin/FormAddTrunk" role="button">Tambah Data</a>
