    ...
    <div class="main-panel">
        ...
        <div class="content">
            ...
            <center>
                    ...
                    <?php
                        echo form_open_multipart ("admin/AksiEditCable", array("class"=>"form-horizontal"));
                           foreach ($kabel as $e) {       
                    ...
                    ?>
                    <span style="width:10%; text-align:right;  display: inline-block;"><a class="small-text" href="<?php echo base_url('index.php/admin/data_cable')?>">Batal</a></span>
            </center>
            </div>
        </div>
