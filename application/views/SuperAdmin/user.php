    ...
    <div class="main-panel">
        ...
        <div class="content">
            <div class="container-fluid">
              <h3>Data Pengguna Witel Banten Timur</h3>
                <table align="center" cellspacing="0" cellpadding="5" width="100%">
                    ...
                    <?php
                     ...
                     foreach ($akun as $k) {
                       echo "<tr>
                               ...
                               <td>$k->keaktifan</td>
                               <td>
                                 <center><a class = 'btn' href='".base_url()."index.php/superadmin/FormEditUser/".$k->id_user."'>Sunting</a></center>
                               </td>
                               <td>
                                 <center><a class = 'btn' href='".base_url()."index.php/superadmin/AksiDeleteUser/".$k->id_user."'>Hapus</a></center>
                               </td>
                            </tr>";
                       $no++;
                     }
                 ...
                 <br>
                 <center>
                    <a button type="button" class="btn btn-default" href="<?php echo base_url() ?>index.php/superadmin/FormAddUser" role="button">Tambah Data</a>
