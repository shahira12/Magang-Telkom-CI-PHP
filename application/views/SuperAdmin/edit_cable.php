...
<div class="wrapper">
    ...
    <div class="main-panel">
        ...
        <div class="content">
            ...
            <center>
                    <h2>FORM EDIT DATA KABEL METRO</h2><br>
                    <?php
                        echo form_open_multipart ("superadmin/AksiEditCable", array("class"=>"form-horizontal"));
                           foreach ($kabel as $e) {       
                            echo form_input(array("name"  => "nama_kabel",
                                                  "value" => $e->nama_kabel,
                                                  "class" => "form-control",
                                                  "placeholder" => "Nama Kabel",
                                                  "type"  => "text"));
                            echo form_input(array("name"  => "tipe_kabel",
                                                  "class" => "form-control",
                                                   "value" => $e->tipe_kabel,
                                                  "placeholder" => "Tipe Kabel",
                                                  "type"  => "text"));
                            echo form_input(array("name"  => "warna",
                                                  "class" => "form-control",
                                                   "value" => $e->warna,
                                                  "placeholder" => "Warna Kabel",
                                                  "type"  => "text"));
                            echo form_input(array("name"  => "kegunaan",
                                                  "class" => "form-control",
                                                   "value" => $e->kegunaan,
                                                  "placeholder" => "Kegunaan Kabel",
                                                  "type"  => "text"));
                            echo form_input(array("name"  => "keterangan",
                                                  "class" => "form-control",
                                                   "value" => $e->keterangan,
                                                  "placeholder" => "Jumlah dan Kualitas Kabel",
                                                  "type"  => "text"));
                            echo "<br>";
                            echo form_input (array("name" => "foto",
                                                   "type" => "file"));
                            echo "<br>";
                            echo form_input(array("name"  => "kode_kabel",                             
                                                  "value" => $e->kode_kabel,                             
                                                  "type"  => "hidden"));
                    ...
                    ?>
                    <span style="width:10%; text-align:right;  display: inline-block;"><a class="small-text" href="<?php echo base_url('index.php/superadmin/data_cable')?>">Batal</a></span>
            </center>
            </div>
        </div>
