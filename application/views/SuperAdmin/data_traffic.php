    ...
    <div class="main-panel">
        ...
        <div class="content">
            <div class="container-fluid">
                        ...
                        <h3>Data Traffic Metro Witel Banten Timur</h3>
                            <table align="center" cellspacing="0" cellpadding="5" width="100%">
                            <thead>
                                <th><center>No.</center></th>
                                <th><center>Lokasi</center></th>
                                <th><center>Node Asal</center></th>
                                <th><center>Node Tujuan</center></th>
                                <th><center>Bandwidth</center></th>
                                <th><center>Load</center></th>
                                <th><center>Occup</center></th>
                            ...
                            <?php
                                 $no=1;
                                 foreach ($datatraffic as $dt) {
                                   echo "<tr>
                                            <td>$no</td>
                                            <td>$dt->lokasi</td>
                                            <td>$dt->nodeasal</td>
                                            <td>$dt->nodetujuan</td>
                                            <td><center>$dt->bandwidth Gigabit</center></td>
                                            <td><center>$dt->load %</center></td>
                                            <td><center>$dt->occup Gigabit</center></td>
                                            <td>
                                            <center><a class='btn' href='".base_url()."index.php/superadmin/FormEditDataTraffic/".$dt->id_traffic."'>Sunting</a></center>
                                            </td>
                                            <td>
                                            <center><a class='btn' href='".base_url()."index.php/superadmin/AksiDeleteDataTraffic/".$dt->id_traffic."'>Hapus</a></center>
                                           </td>
                                        </tr>";
                                   $no++;
                                }
                        ...
                        <br/>
                        <center>
                            <a button type="button" class="btn btn-default" href="<?php echo base_url() ?>index.php/superadmin/FormAddTraffic" role="button">Tambah Data</a>
