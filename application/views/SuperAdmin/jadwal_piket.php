    ...
    <div class="main-panel">
        ...
        <div class="content">
            <div class="container-fluid">
                              ...
                              <?php
                               ...
                               foreach ($piket as $p) {
                                 echo "<tr>
                                         ...
                                         <td>$p->jam_jaga</td>
                                          <td>
                                            <center><a class = 'btn' href='".base_url()."index.php/superadmin/FormEditPiket/".$p->nik."'>Sunting</a></center>
                                            </td>
                                            <td>
                                            <center><a class = 'btn' href='".base_url()."index.php/superadmin/AksiDeletePiket/".$p->nik."'>Hapus</a></center>
                                           </td>
                                      </tr>";
                                 $no++;
                               }
                 ...
                 <br/>
                        <center>
                            <a button type="button" class="btn btn-default" href="<?php echo base_url() ?>index.php/superadmin/FormAddPiket" role="button">Tambah Data</a>
