    ...
    <div class="main-panel">
        ...
        <div class="content">
            <div class="container-fluid">
                    ...
                    <center>
                    <?php
                        echo form_open_multipart ("superadmin/AksiEditTrunk", array("class"=>"form-horizontal"));
                           foreach ($data_trunk as $u) {
                    ...
                    ?>
                    <span style="width:10%; text-align:right;  display: inline-block;"><a class="small-text" href="<?php echo base_url('index.php/superadmin/data_trunk')?>">Batal</a></span>
                    </center>
                </div>
            </div>
        </div>
