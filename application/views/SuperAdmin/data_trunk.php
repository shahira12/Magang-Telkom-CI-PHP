    ...
    <div class="main-panel">
        ...
        <div class="content">
            <div class="container-fluid">
                        ...
                        <h3>Data Trunk Metro Witel Banten Timur</h3>
                            ...
                            <?php
                                $no=1;
                                 foreach ($data_trunk as $d) {
                                   echo "<tr>
                                            <td>$no</td>
                                            <td>$d->lokasi</td>
                                            <td>$d->node_asal</td>
                                            <td>$d->node_tujuan</td>
                                            <td><center>$d->bandwidth</td>
                                            <td>
                                            <center><a class='btn' href='".base_url()."index.php/superadmin/FormEditTrunk/".$d->id."'>Sunting</a></center>
                                            </td>
                                            <td>
                                            <center><a class='btn' href='".base_url()."index.php/superadmin/AksiDeleteTrunk/".$d->id."'>Hapus</a></center>
                                           </td>
                                        </tr>";
                                    $no++;
                                }
                            ...
                            <br/>
                                <center>
                                    <a button type="button" class="btn btn-default" href="<?php echo base_url() ?>index.php/superadmin/FormAddTrunk" role="button">Tambah Data</a>
